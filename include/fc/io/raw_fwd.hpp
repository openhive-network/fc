...
namespace fc {
   ...
   namespace raw {
    ...
    template<typename Stream, typename IntType, typename EnumType>
    inline void unpack( Stream& s, fc::enum_type<IntType,EnumType>& tp, uint32_t depth = 0, bool limit_is_disabled = false );



    template<typename Stream, typename... T> inline void pack( Stream& s, const std::set<T...>& value );
    template<typename Stream, typename... T> inline void unpack( Stream& s, std::set<T...>& value, uint32_t depth = 0, bool limit_is_disabled = false );
    template<typename Stream, typename... T> inline void pack( Stream& s, const std::multiset<T...>& value );
    template<typename Stream, typename... T> inline void unpack( Stream& s, std::multiset<T...>& value, uint32_t depth = 0, bool limit_is_disabled = false );
    template<typename Stream, typename T> inline void pack( Stream& s, const std::unordered_set<T>& value );
    template<typename Stream, typename T> inline void unpack( Stream& s, std::unordered_set<T>& value, uint32_t depth = 0, bool limit_is_disabled = false );

    template<typename Stream, typename... T> void pack( Stream& s, const static_variant<T...>& sv );
    template<typename Stream, typename... T> void unpack( Stream& s, static_variant<T...>& sv, uint32_t depth = 0, bool limit_is_disabled = false );

    template<typename Stream, typename K, typename V> inline void pack( Stream& s, const std::unordered_map<K,V>& value );
    template<typename Stream, typename K, typename V> inline void unpack( Stream& s, std::unordered_map<K,V>& value, uint32_t depth = 0, bool limit_is_disabled = false );

    template<typename Stream, typename K, typename V> inline void pack( Stream& s, const std::map<K,V>& value );
    template<typename Stream, typename K, typename V> inline void unpack( Stream& s, std::map<K,V>& value, uint32_t depth = 0, bool limit_is_disabled = false );

    template<typename Stream, typename K, typename V> inline void pack( Stream& s, const std::pair<K,V>& value );
    template<typename Stream, typename K, typename V> inline void unpack( Stream& s, std::pair<K,V>& value, uint32_t depth = 0, bool limit_is_disabled = false );

    template<typename Stream, typename T> inline void unpack( Stream& s, std::optional<T>& v, uint32_t depth = 0, bool limit_is_disabled = false );
    ...
    template<typename Stream> inline void unpack( Stream& s, variant_object& v, uint32_t depth = 0, bool limit_is_disabled = false );
    template<typename Stream> inline void pack( Stream& s, const variant& v );
    template<typename Stream> inline void unpack( Stream& s, variant& v, uint32_t depth = 0, bool limit_is_disabled = false );

    template<typename Stream> inline void pack( Stream& s, const path& v );
    template<typename Stream> inline void unpack( Stream& s, path& v, uint32_t depth = 0, bool limit_is_disabled = false );
    ...
    template<typename Stream, typename T> void unpack( Stream& s, fc::safe<T>& v, uint32_t depth = 0, bool limit_is_disabled = false );

    template<typename Stream> void unpack( Stream& s, microseconds&, uint32_t depth = 0, bool limit_is_disabled = false );
    template<typename Stream> void pack( Stream& s, const microseconds& );
    template<typename Stream> void unpack( Stream& s, time_point&, uint32_t depth = 0, bool limit_is_disabled = false );
    template<typename Stream> void pack( Stream& s, const time_point& );
    template<typename Stream> void unpack( Stream& s, time_point_sec&, uint32_t depth = 0, bool limit_is_disabled = false );
    template<typename Stream> void pack( Stream& s, const time_point_sec& );
    template<typename Stream> void unpack( Stream& s, std::string&, uint32_t depth = 0, bool limit_is_disabled = false );
    template<typename Stream> void pack( Stream& s, const std::string& );
    template<typename Stream> void unpack( Stream& s, fc::ecc::public_key&, uint32_t depth = 0, bool limit_is_disabled = false );
    template<typename Stream> void pack( Stream& s, const fc::ecc::public_key& );
    template<typename Stream> void unpack( Stream& s, fc::ecc::private_key&, uint32_t depth = 0, bool limit_is_disabled = false );
    ...
    template<typename Stream, typename T> inline void unpack( Stream& s, T& v, uint32_t depth = 0, bool limit_is_disabled = false );

    template<typename Stream, typename T> inline void pack( Stream& s, const std::vector<T>& v );
    template<typename Stream, typename T> inline void unpack( Stream& s, std::vector<T>& v, uint32_t depth = 0, bool limit_is_disabled = false );

    template<typename Stream> inline void pack( Stream& s, const signed_int& v );
    template<typename Stream> inline void unpack( Stream& s, signed_int& vi, uint32_t depth = 0, bool limit_is_disabled = false );

    template<typename Stream> inline void pack( Stream& s, const unsigned_int& v );
    template<typename Stream> inline void unpack( Stream& s, unsigned_int& vi, uint32_t depth = 0, bool limit_is_disabled = false );

    template<typename Stream> inline void pack( Stream& s, const char* v );
    template<typename Stream> inline void pack( Stream& s, const std::vector<char>& value );
    template<typename Stream> inline void unpack( Stream& s, std::vector<char>& value, uint32_t depth = 0, bool limit_is_disabled = false );

    template<typename Stream, typename T, size_t N> inline void pack( Stream& s, const fc::array<T,N>& v);
    template<typename Stream, typename T, size_t N> inline void unpack( Stream& s, fc::array<T,N>& v, uint32_t depth = 0, bool limit_is_disabled = false );

    template<typename Stream, typename T, size_t N> inline void pack( Stream& s, const fc::int_array<T,N>& v);
    template<typename Stream, typename T, size_t N> inline void unpack( Stream& s, fc::int_array<T,N>& v, uint32_t depth = 0, bool limit_is_disabled = false );

    template<typename Stream> inline void pack( Stream& s, const bool& v );
    template<typename Stream> inline void unpack( Stream& s, bool& v, uint32_t depth = 0, bool limit_is_disabled = false );
    ...
    template<typename T> inline T unpack_from_char_array( const char* d, uint32_t s, uint32_t depth = 0, bool limit_is_disabled = false );
    template<typename T> inline void unpack_from_char_array( const char* d, uint32_t s, T& v, uint32_t depth = 0, bool limit_is_disabled = false );
} }
